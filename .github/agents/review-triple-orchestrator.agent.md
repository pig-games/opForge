...
2. the branch-local review template [templates/review-report-template.md](/Users/erik/Code/Retro/opForge/worktrees/libopforge-lib/templates/review-report-template.md)
3. the review scope
