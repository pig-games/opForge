...
i8085_direct
        ...
        lda TABLE              ; load HL direct
        lda PAGE + $80         ; with expression
        sta TABLE + $100       ; store HL direct
...
i8085_io
        .byte IO_DATA              ; input from label
        .byte IO_BASE + 1          ; input from expression
        .byte IO_STATUS           ; output to label
        .byte IO_BASE + 2         ; output to expression
