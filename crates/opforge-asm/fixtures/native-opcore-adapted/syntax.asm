...
; would be allowed.  It evaluates to the ASCII value of the single character.
        lda #65           ; Move the letter 'A' into register C.
        lda #041H         ; Move the letter 'A' into register C.
        lda #'A'          ; Move the letter 'A' into register C.
...
SP     .word      256             ; define a word at location named SP
        .word SP            ; laod address of "SP" word into HL pair
        .word SP+0
        .word 0+SP
