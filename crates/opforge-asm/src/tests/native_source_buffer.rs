...
fn native_source_buffer_refill_boundaries_fs_uae() {
    ...
    .expect("source buffer refill parity")
    {
        ...
        crate::fs_uae_smoke::FsUaeSmokeOutcome::Completed { runs } => {
            ...
            // Existing include reporting differs from Rust stdout. Keep its exact
            // native contract in both modes; full stream parity remains A-close debt.
            assert_eq!(guest_stdout, b"INCLUDE-LINE 1 1\n");
            assert!(
