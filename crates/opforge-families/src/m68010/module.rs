...
use super::M68010CpuHandler;

pub struct M68010CpuModule;

pub const CPU_ID: CpuType = CpuType::new("m68010");
const CPU_ALIASES: &[&str] = &["68010", "mc68010"];

impl CpuModule for M68010CpuModule {
    ...
    fn handler(&self) -> Box<dyn CpuHandlerDyn> {
        Box::new(M68010CpuHandler::new())
    }
}

impl CpuHandlerDyn for M68010CpuHandler {
    fn cpu_id(&self) -> CpuType {
        CPU_ID
    }
