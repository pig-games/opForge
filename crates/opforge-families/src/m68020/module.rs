...
impl CpuModule for M68020CpuModule {
    ...
    fn register_ids(&self) -> &'static [&'static str] {
        crate::families::m68k::package_programs::M68020_CONTROL_REGISTER_IDS
    }
    ...
    fn form_mnemonics(&self) -> Vec<String> {
        ...
        forms.extend(
            crate::families::m68k::package_programs::m68020_instruction_form_mnemonics(true),
        );
    ...
    fn mode_selectors(
        ...
        selectors.extend(
            crate::families::m68k::package_programs::m68020_mode_selectors(CPU_ID.as_str(), true),
        );
        selectors.extend(
