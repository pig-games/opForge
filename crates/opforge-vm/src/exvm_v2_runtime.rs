...
impl ExvmV2Runtime {
    ...
    fn build_binary_expr(
        ...
        let op = match operator {
            ...
            ExvmOperatorKindV2::Shl => BinaryOp::Shl,
            ExvmOperatorKindV2::Shr => BinaryOp::Shr,
            ExvmOperatorKindV2::Eq => BinaryOp::Eq,
            ExvmOperatorKindV2::Ne => BinaryOp::Ne,
            ExvmOperatorKindV2::Ge => BinaryOp::Ge,
            ExvmOperatorKindV2::Gt => BinaryOp::Gt,
            ExvmOperatorKindV2::Le => BinaryOp::Le,
            ExvmOperatorKindV2::Lt => BinaryOp::Lt,
            ExvmOperatorKindV2::BitAnd => BinaryOp::BitAnd,
            ExvmOperatorKindV2::BitOr => BinaryOp::BitOr,
            ExvmOperatorKindV2::BitXor => BinaryOp::BitXor,
            ExvmOperatorKindV2::LogicAnd => BinaryOp::LogicAnd,
            ExvmOperatorKindV2::LogicOr => BinaryOp::LogicOr,
            ExvmOperatorKindV2::LogicXor => BinaryOp::LogicXor,
            _ => {
                return Err(ParseError {
