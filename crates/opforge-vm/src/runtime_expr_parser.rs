...
pub(crate) fn parse_exvm_scalar_expression_tokens(
    tokens: Vec<Token>,
    end_span: Span,
    end_token_text: Option<String>,
) -> Result<Expr, ParseError> {
    ExvmScalarExpressionParser::new(tokens, end_span, end_token_text).parse_expr_from_tokens()
}

struct ExvmScalarExpressionParser {
    tokens: Vec<Token>,
    index: usize,
    end_span: Span,
    end_token_text: Option<String>,
...
impl ExvmScalarExpressionParser {
