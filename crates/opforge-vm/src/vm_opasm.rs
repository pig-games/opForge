...
#[allow(clippy::too_many_arguments)]
pub fn parse_statement_tokens_with_model_and_expr_handler_with_rollout_overrides<'a>(
    model: &'a HierarchyExecutionModel,
    cpu_id: &'a str,
    dialect_override: Option<&'a str>,
    expr_parser_opt_in_families: &'a [String],
    ...
    crate::vm_opasm_parse::parse_tokens_with_model_with_expr_handler_and_rollout_overrides(
        model,
        cpu_id,
        dialect_override,
        expr_parser_opt_in_families,
...
pub(crate) fn parse_operand_expr_range(
    ...
    let mut parse_wrapped_or_expr =
        |inner_tokens: &[Token], inner_end_span: Span, inner_end_token_text: Option<String>| {
            parse_wrapped_operand_or_expr(
                expr_parse_ctx,
                inner_tokens,
                inner_end_span,
                inner_end_token_text,
    ...
    if let Some(expr) = expr_parse_ctx.model.parse_family_operand_surface_expr(
        ...
        hints.operand_index,
        expr_end_span,
        boundary.end_token_text.as_deref(),
        &mut parse_expr,
...
fn parse_wrapped_operand_or_expr(
    expr_parse_ctx: &crate::vm_opasm_parse::VmExprParseContext<'_>,
    tokens: &[Token],
    end_span: Span,
    end_token_text: Option<String>,
