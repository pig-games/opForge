...
**Current step: Step 29 of 39 · Item A-listing-reservation — consume the qualified scalar result for reservation placement and listing.** Update this pointer and total when the active item or plan changes.
...
- [ ] Step 29 · Item A-listing-reservation — Render reservation status, address and size in source rows
  ...
  - Full quality gates: mandatory non-LSP Rust, staged native and workflow/plan validators; broad qualification remains at A-close.
  - Plan-compliance review evidence: independent reservation classification, resolved address/size, no-output semantics and proof-boundary review before commit.
