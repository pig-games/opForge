...
NCLI_PARSE_DEFINE_CAPACITY      = -12
NCLI_PARSE_INVALID_GO          = -13
NCLI_PARSE_GO_REQUIRES_OUTPUT  = -14
...
NATIVE_OUTPUT_FORMAT_SREC       = 6

NATIVE_MAP_SYMBOLS_NONE         = 0
NATIVE_MAP_SYMBOLS_PUBLIC       = 1
NATIVE_MAP_SYMBOLS_ALL          = 2

NATIVE_ARTIFACT_REQUEST_OUTPUT         = 1
NATIVE_ARTIFACT_REQUEST_MAPFILE        = 2
NATIVE_ARTIFACT_REQUEST_EXPORTSECTIONS = 3
NATIVE_ARTIFACT_REQUEST_METADATA_LIST  = 4
NATIVE_ARTIFACT_REQUEST_METADATA_HEX   = 5
NATIVE_ARTIFACT_REQUEST_METADATA_BIN   = 6
NATIVE_ARTIFACT_REQUEST_CAPACITY       = 16
NATIVE_SOURCE_OUTPUT_SECTION_CAPACITY  = 16
NATIVE_SOURCE_OUTPUT_SECTION_NAME_CAPACITY = 32

PATH_BUFFER_CAPACITY            = 256
TOKEN_BUFFER_CAPACITY           = 64
; Imported ordinary names are returned fully qualified. The registered native
; product reaches 66 bytes here, while opasm's established label domain retains
; 107 name bytes plus NUL.
NATIVE_RESOLVED_IMPORT_NAME_CAPACITY = 108
...
NATIVE_ASSEMBLY_SESSION_HEADER_BYTES = 92
...
NATIVE_ASSEMBLY_SESSION_TAIL_BYTES = 12
...
PRVM_STATUS_EXPR_RESUME_LIMIT   = $FFFFFFD1
...
NATIVE_EVAL_EXPR_EXTENSION_BYTES = 36
