...
NATIVE_PREPROCESS_STATE_BYTES   = 8 + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * 2) + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * 2) + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * NATIVE_PREPROCESS_BODY_LINE_CAPACITY * 2) + ((NATIVE_PREPROCESS_DEFINITION_CAPACITY + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * NATIVE_PREPROCESS_BODY_LINE_CAPACITY)) * SOURCE_LINE_BUFFER_CAPACITY) + (2 * SOURCE_LINE_BUFFER_CAPACITY)
