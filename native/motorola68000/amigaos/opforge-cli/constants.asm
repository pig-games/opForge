...
NATIVE_PREPROCESS_STATE_BYTES   = 36 + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * 2) + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * 2) + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * NATIVE_PREPROCESS_BODY_LINE_CAPACITY * 2) + ((NATIVE_PREPROCESS_DEFINITION_CAPACITY + (NATIVE_PREPROCESS_DEFINITION_CAPACITY * NATIVE_PREPROCESS_BODY_LINE_CAPACITY)) * SOURCE_LINE_BUFFER_CAPACITY) + (NATIVE_PREPROCESS_MACRO_ARG_CAPACITY * SOURCE_LINE_BUFFER_CAPACITY) + (4 * SOURCE_LINE_BUFFER_CAPACITY)
