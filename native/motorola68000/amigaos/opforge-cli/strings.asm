...
defaultFsUaeArgTail
.ifdef OPFORGE_FS_UAE_NATIVE_CLI_DEBUG_EVENT
	.byte "Work:opforge_fsuae_smoke_input.asm --bin Work:opforge_native_out.bin --cpu m6502 --native-debug", 0
.else
.ifdef OPFORGE_FS_UAE_NATIVE_CLI_ITEM5_DIRECTIVE_ROUTER
	.byte "Work:opforge_6502_native_cli_smoke.asm --bin Work:opforge_native_out.bin --cpu m6502", 0
.else
.ifdef OPFORGE_FS_UAE_NATIVE_CLI_ITEM5_FLOW_NAVIGATION
	.byte "Work:opforge_6502_native_cli_smoke.asm --bin Work:opforge_native_out.bin --cpu m6502", 0
.else
...
.ifdef OPFORGE_FS_UAE_NATIVE_CLI_MODULE_PATH_OVERFLOW
	.byte "Work:opforge_fsuae_smoke_input.asm --bin Work:opforge_native_out.bin --cpu m68020 -M Work:mod1 -M Work:mod2 -M Work:mod3 -M Work:mod4 -M Work:mod5 -M Work:mod6 -M Work:mod7 -M Work:mod8 -M Work:mod9", 0
.else
