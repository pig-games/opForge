...
; on AmigaOS.
	...
	.use tkpkg.amigaos.abi (CB_EXTENSION_PTR, CB_EXTENSION_LEN, CB_INPUT_PTR)
	.use tkpkg.amigaos.abi (CB_INPUT_LEN, CB_OUTPUT_LEN)
	.use tkpkg.amigaos.abi (CB_STATUS_CODE, CB_LAST_ERROR_LEN)
