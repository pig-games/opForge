...
OPERAND_RECORD_RESULT_INDEX_WIDTH    = 22
OPERAND_RECORD_RESULT_INDIRECTION    = 23
OPERAND_RECORD_RESULT_OUTER_VALUE    = 24
OPERAND_RECORD_RESULT_OUTER_WIDTH    = 32
OPERAND_RECORD_RESULT_FLAGS          = 3
