...
SNAPSHOTS = {
    "opasm.amigaos.assembly_driver": ("fb80f1af11ea494869cfbd716d68ff6fb75921a696c8739b90704c1004be2ff5", 70, 18, ("code", "data", "bss"), 141),
    ...
    "opasm.amigaos.engine": ("071b57eab5503c83e030d815f3eaf918f1eb3dd21096c66b6e61625636afdd0c", 70, 1, ("code", "bss"), 21),
    "tkpkg.amigaos.tokenizer_vm": ("7bbafa635dcded0236c9a65368db47e0e10aded6b328d4389e580654125e5b65", 31, 5, ("data", "code"), 124),
    "opcore.amigaos.expr_bridge": ("012e2676bcc4f7dc1da355936a554bee44f00ffd2c82abdaacd1a1968834da07", 30, 1, ("code", "bss"), 5),
