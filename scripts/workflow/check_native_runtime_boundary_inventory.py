...
TARGETS = {
    ...
    "tkpkg.amigaos.encoding_execution": (
        "native/motorola68000/amigaos/tkpkg/tkpkg_encoding_execution.asm",
        "semantic",
        ("debug.amigaos.runtime_profile",),
    ),
    "tkpkg.amigaos.value_execution": (
        "native/motorola68000/amigaos/tkpkg/tkpkg_value_execution.asm",
        "execute",
        ("debug.amigaos.runtime_profile",),
    ),
    "tkpkg.amigaos.compact_table": (
...
SNAPSHOTS = {
    ...
    "tkpkg.amigaos.selection_service": ('a7d29067b7c3ba572ba2c014613ddc5894119d09e20538931dcc7a1aca233846', 84, 9, ('data', 'code'), 233),
    "tkpkg.amigaos.operand_runtime": ("8ccf698f85b2fa2e675109ab119f8918c478fb3bc94f661980a14d0fee1d65d8", 23, 5, ("data", "code"), 60),
    "tkpkg.amigaos.encode_service": ('56b02debaeb6ba78617dde66693f3371135acf3b771b73e18f0919b2fd4283af', 20, 8, ('data', 'bss', 'code'), 19),
    "tkpkg.amigaos.encoding_execution": ('9cb43477d1f37637ec443f4ed78b6e6eaa63f119adcc6db1306ee4391589b5d7', 19, 1, ('data', 'code'), 8),
    "tkpkg.amigaos.value_execution": ('5903e6b24e031de36de81db4577e9648821a44c0d69d27b76467aeae8667cecb', 2, 1, ('code',), 0),
